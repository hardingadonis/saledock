                                        ...
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                <form action="./add-product" method="post">
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="mb-3"><label class="form-label" for="categoryID"><strong>Thể loại ID</strong></label><input class="form-control" type="text" id="categoryID" placeholder="Nhập ID danh mục" name="categoryID"></div>
                                                        </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="mb-3"><label class="form-label" for="description"><strong>Mô tả sản phẩm</strong></label><input class="form-control" type="text" id="description" placeholder="Nhập mô tả sản phẩm" name="description"></div>
