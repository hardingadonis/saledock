...
<html data-bs-theme="light" lang="en">
    ...
    <head>
        ...
        <title>Sale Dock - Đăng nhập</title>
                                ...
                                <div class="col-lg-6 m-auto">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h4 class="text-dark mb-4">Password Reset Sale Dock</h4>
                                        </div>
                                        <div class="container">
                                            <c:choose>
                                                ...
                                                <c:when test="${param.message eq 'notExists'}">
                                                    <div class="alert alert-danger text-center" role="alert">
                                                        No Employee Found With The Given Code
                                                    </div>
                                                </c:when>
                                            </c:choose>
