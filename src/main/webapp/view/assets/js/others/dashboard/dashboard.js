...
duration.addEventListener("change", function() { initChart(); });
...
function initChartCustomerTop10() {
  ...
  fetch(API_ENDPOINT + "customer?duration=" + duration.value, {method : "GET"})
      .then((response) => response.json())
      .then((data) => {
...
function initChartProductTop10() {
  ...
  fetch(API_ENDPOINT + "product?duration=" + duration.value, {method : "GET"})
      .then((response) => response.json())
      .then((data) => {
